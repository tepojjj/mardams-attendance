...
// per calendar date. Accounting and the Super Admin manage this list —
// the same two roles who already run Payroll — since it's what tells
...
module.exports = async (req, res) => {
  // List holidays, optionally within a date range. Accounting/Super Admin
